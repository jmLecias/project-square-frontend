        ...
        <div className='queue-item box-shadow mb-2 fade-in'>
            <div className='d-flex align-items-center' style={{ width: 'fit-content' }}>
                <div
                    ...
                    style={{ width: '60px', borderRadius: '5px', cursor: 'zoom-in', borderColor: 'orange' }}
                ...
                <FaArrowRight size={24} style={{ color: 'orange'}} />
                <div
                    className='square-item-cover my-auto'
                    style={{ width: '60px', borderRadius: '5px',  borderColor: 'orange'}}
                >
                    <img
                        src={detection.image}
                        alt={`database image`}
            ...
            <div className='details ms-2 d-flex flex-column justify-content-center'>
                <span
                    className='item-date opacity-50 text-truncate fw-bold'
                    style={{ fontSize: '14px',  borderColor: 'orange' }}
                >Non-Member Detected</span>
